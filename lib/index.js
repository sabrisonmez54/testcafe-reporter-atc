      ...
      "results":[
        {
          ...
          "log":"${generateLogSection(testRunInfo)}"
                ...
                fs.appendFileSync(jiraUploadAllReportsPath, `${curlCommandUploadXrayJsonResults}\n`);
                ...
                fs.appendFileSync(jiraUploadAllReportsPath, `${curlCommandSetExecutionTestTicketStatus}\n\n`);
            }
        },
